...
public class StampPlay extends Activity implements BluetoothAdapter.LeScanCallback {
    ...
    private final String[] name = new String[]{"스탬프"};
    ...
    public void onClickStar1(View v){
        ...
        try {
            ...
            if (v.getId() == R.id.toggleButton) {
                Cursor c = sampleDB.rawQuery("SELECT * FROM person WHERE name = '스탬프'", null);
                ...
                if (c != null && c.getCount()==0) {
                    ...
                    sampleDB.execSQL("DELETE FROM person WHERE name = '스탬프'");
                }
            }
    ...
    protected void showList(){
        ...
        try {
            ...
            Cursor c1 = ReadDB.rawQuery("SELECT * FROM " + tableName+ " WHERE name = '스탬프'", null);
    ...
    private final Runnable check = new Runnable() {
        ...
        public void run() {
            ...
            if(Device1 != null && Device2 != null) {
                ...
                blechecked=true;
                init();
                Toast.makeText(StampPlay.this,"연결 성공",Toast.LENGTH_SHORT).show();
                iv.setImageResource(R.drawable.first);
    ...
    private final Runnable moving = new Runnable() {
        ...
        public void run() {
            if(stay==false){
                Toast.makeText(StampPlay.this,"연습을 시작해주세요",Toast.LENGTH_SHORT).show();
            }
        }
    };
    ...
    private final BluetoothGattCallback mGattcallback = new BluetoothGattCallback() {
        ...
        public void onCharacteristicRead(BluetoothGatt gatt,
            ...
            if (status == BluetoothGatt.GATT_SUCCESS) {
                ...
                if(i==4 | i==1 | i==2 | i==3){
                    characteristic2.setValue(21, BluetoothGattCharacteristic.FORMAT_UINT8, 0);
