...
public class DigPlay extends Activity implements BluetoothAdapter.LeScanCallback {
    ...
    public void onClickStar1(View v){
        ...
        try {
            ...
            if (v.getId() == R.id.toggleButton) {
                Cursor c = sampleDB.rawQuery("SELECT * FROM person WHERE name = '딕'", null);
                ...
                if (c != null && c.getCount()==0) {
                    ...
                    sampleDB.execSQL("DELETE FROM person WHERE name = '딕'");
                }
            }
    ...
    protected void showList(){
        ...
        try {
            ...
            Cursor c1 = ReadDB.rawQuery("SELECT * FROM " + tableName+ " WHERE name = '딕'", null);
