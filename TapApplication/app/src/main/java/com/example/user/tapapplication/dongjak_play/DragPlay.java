...
public class DragPlay extends Activity implements BluetoothAdapter.LeScanCallback {
    ...
    private final String[] name = new String[]{"드래그"};
    ...
    public int [] ans =  { 3,23,3,23,3 }; // 답 스위치 위치
    ...
    public void onClickStar1(View v){
        ...
        try {
            ...
            if (v.getId() == R.id.toggleButton) {
                Cursor c = sampleDB.rawQuery("SELECT * FROM person WHERE name = '드래그'", null);
                ...
                if (c != null && c.getCount()==0) {
                    ...
                    sampleDB.execSQL("DELETE FROM person WHERE name = '드래그'");
                }
            }
    ...
    protected void showList(){
        ...
        try {
            ...
            Cursor c1 = ReadDB.rawQuery("SELECT * FROM " + tableName+ " WHERE name = '드래그'", null);
    ...
    private final Runnable check = new Runnable() {
        ...
        public void run() {
            ...
            if(Device1 != null && Device2 != null) {
                ...
                blechecked=true;
                init();
                Toast.makeText(DragPlay.this,"연결 성공",Toast.LENGTH_SHORT).show();
                iv.setImageResource(R.drawable.first);
    ...
    private final Runnable moving = new Runnable() {
        ...
        public void run() {
            if(stay==false){
                Toast.makeText(DragPlay.this,"연습을 시작해주세요",Toast.LENGTH_SHORT).show();
            }
        }
    };
    @Override
    ...
    private final BluetoothGattCallback mGattcallback = new BluetoothGattCallback() {
        ...
        public void onCharacteristicRead(BluetoothGatt gatt,
           ...
           /*         if (i==8) {
                ...
                if(i>22 && i<25){ //3,4면 여기
                    data2 = i;
                    Log.d("Read","data2 was read : "+data2);
                }
                //왼발은 양쪽 다 있는 거 검사하기 위함
