...
public class HopshuPlay extends Activity implements BluetoothAdapter.LeScanCallback {
    ...
    private final String[] name = new String[]{"홉셔플"};
    ...
    public void onClickStar1(View v){
        ...
        try {
            ...
            if (v.getId() == R.id.toggleButton) {
                Cursor c = sampleDB.rawQuery("SELECT * FROM person WHERE name = '홉셔플'", null);
                ...
                if (c != null && c.getCount()==0) {
                    ...
                    sampleDB.execSQL("DELETE FROM person WHERE name = '홉셔플'");
                }
            }
    ...
    protected void showList(){
        ...
        try {
            ...
            Cursor c1 = ReadDB.rawQuery("SELECT * FROM " + tableName+ " WHERE name = '홉셔플'", null);
