...
public class BuffPlay extends Activity implements BluetoothAdapter.LeScanCallback {
    ...
    private final String[] name = new String[]{"버팔로"};
    ...
    public void onClickStar1(View v){
        if (toggle.isChecked()){
            toggle.setBackgroundDrawable(getResources().
                    getDrawable(R.drawable.starclick));
            Toast.makeText(BuffPlay.this,"즐겨찾기 추가",Toast.LENGTH_SHORT).show();}
        else{
            toggle.setBackgroundDrawable(getResources().
                    getDrawable(R.drawable.staroff));
            Toast.makeText(BuffPlay.this,"즐겨찾기 해제",Toast.LENGTH_SHORT).show();
        }
        try {
            ...
            if (v.getId() == R.id.toggleButton) {
                Cursor c = sampleDB.rawQuery("SELECT * FROM person WHERE name = '버팔로'", null);
                ...
                if (c != null && c.getCount()==0) {
                    ...
                    sampleDB.execSQL("DELETE FROM person WHERE name = '버팔로'");
                }
            }
    ...
    protected void showList(){
        ...
        try {
            ...
            Cursor c1 = ReadDB.rawQuery("SELECT * FROM " + tableName+ " WHERE name = '버팔로'", null);
    ...
    private final Runnable check = new Runnable() {
        ...
        public void run() {
            ...
            if(Device1 != null && Device2 != null) {
                ...
                blechecked=true;
                init();
                Toast.makeText(BuffPlay.this,"연결 성공",Toast.LENGTH_SHORT).show();
                iv.setImageResource(R.drawable.first);
    ...
    private final Runnable moving = new Runnable() {
        ...
        public void run() {
            if(stay==false){
                Toast.makeText(BuffPlay.this,"연습을 시작해주세요",Toast.LENGTH_SHORT).show();
            }
        }
    };
